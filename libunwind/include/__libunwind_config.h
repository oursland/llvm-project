...
#define _LIBUNWIND_HIGHEST_DWARF_REGISTER_SH        93
...
#elif defined(__sh__)
#define _LIBUNWIND_TARGET_SH 1
#define _LIBUNWIND_CONTEXT_SIZE 28
#define _LIBUNWIND_CURSOR_SIZE 35
#define _LIBUNWIND_HIGHEST_DWARF_REGISTER _LIBUNWIND_HIGHEST_DWARF_REGISTER_SH
